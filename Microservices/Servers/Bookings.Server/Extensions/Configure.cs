...
#pragma warning restore CS8604 // Возможно, аргумент-ссылка, допускающий значение NULL.
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Version = "v1",
                Title = "Сервер бронирования",
                Description = "CRUD запросы бронирований",
        ...
        services.AddDbContext<BookingDbContext>(options => options.UseNpgsql(connectionString, b => b.MigrationsAssembly("Bookings.Server")));
